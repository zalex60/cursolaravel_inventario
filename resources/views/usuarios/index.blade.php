        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Usuarios
                    <button class="btn btn-primary"  data-toggle="modal" data-target="#modalUsuario">Agregar Usuario</button>
</div>
                <div class="card-body">
<table class="table"> 
...
<div class="modal fade" id="modalUsuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      {!! Form::open(array('url'=>'usuarios/store','method'=>'POST','id'=>'formUser')) !!} {!! csrf_field() !!} 
      <div class="modal-body">

<div class="form-group"> 
    <div class="row"> 
        <div class="col-md-6"> 
            {{Form::label('nombre', 'Nombre')}} {!! Form::text('nombre', null, ['class'=>'form-control', 'id' => 'nombre'])!!} 
        </div> 
        <div class="col-md-6"> 
            {{Form::label('email', 'E-Mail Address')}} {!! Form::text('email', null, ['class'=>'form-control', 'id' => 'email'])!!} 
        </div> 
        <div class="col-md-6">
